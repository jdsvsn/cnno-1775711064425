...
const basePath = '/cnno-1775711064425';
...
export default function Home() {
  ...
  const products = [{ n: 'OG Rolls', d: 'Our signature OG Rolls are a masterclass in traditional cinnamon roll craftsmanship, featuring soft, fluffy dough, rich cinnamon flavor, and a sweet glaze that will leave you craving more. Perfect for those seeking a classic treat.', i: 'https://images.pexels.com/photos/5507697/pexels-photo-5507697.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Pistachio Rolls', d: 'For a unique twist on our classic recipe, our Pistachio Rolls combine the warmth of cinnamon with the crunch and nutty flavor of pistachios, creating a delightful harmony of textures and tastes that will elevate your snacking experience.', i: 'https://images.pexels.com/photos/36835363/pexels-photo-36835363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Chocolate Rolls', d: 'Indulge in the richness of our Chocolate Rolls, where decadent chocolate and soft, airy dough come together in perfect harmony, satisfying any chocolate lover\'s cravings and providing a luxurious treat for the senses.', i: 'https://images.pexels.com/photos/7916094/pexels-photo-7916094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Baby Rolls', d: 'Our adorable Baby Rolls are the perfect snack size, packed with the same love and care as our larger rolls but in a bite-sized package, ideal for on-the-go indulgence or as a sweet treat for the little ones.', i: 'https://images.pexels.com/photos/17584799/pexels-photo-17584799.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Party Box', d: 'Gather your friends and family with our Party Box, a delightful assortment of our signature rolls designed to make any celebration sweeter, featuring a variety of flavors to cater to every taste and preference.', i: 'https://images.pexels.com/photos/32422489/pexels-photo-32422489.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft exceptional cinnamon rolls that warm the hearts and souls of our community, one delicious batch at a time.</p>
                </div>
                <div className="space-y-2">
